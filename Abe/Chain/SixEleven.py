# Copyright(C) 2014, 2015 by Abe and 611 developers.
...
from .Sha256SilAuxPowChain import Sha256SilAuxPowChain
...
class SixEleven(Sha256SilAuxPowChain):
    """
    SixEleven represents name operations in transaction output scripts.
    """
    def __init__(chain, **kwargs):
        chain.name = 'SixEleven'
        chain.code3 = 'SIL'
        chain.address_version = '\x34'
        chain.magic = '\xf9\xbe\xb6\x11'
        Sha256SilAuxPowChain.__init__(chain, **kwargs)
    ...
    def parse_decoded_txout_script(chain, decoded):
        ...
        script_type2, data2 = Sha256SilAuxPowChain.parse_decoded_txout_script(chain, decoded[start:])
    ...
    datadir_conf_file_name = "611.conf"
    datadir_rpcport = 8663
